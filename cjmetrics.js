...
BY: JESSE HAZEL
FOR COURIER-JOURNAL.COM
LAST UPDATE: 7/8/15
******************************************/


function cjmetrics(custom_options){
	...
	var options = {
		...
		'sc_currencycode': 'USD',
		'sc_dc': 122,
		'sc_server': window.location.href,
		'sc_prop1':'',
		'sc_prop2':'',
		'sc_prop3':'',
		'sc_prop4':'',
	...
	if(typeof custom_options == 'undefined'){
		...
		if (meta_author != ''){
			...
			var class_author = document.querySelectorAll('.title')[0].innerHTML;
			if (class_author !=''){
				options.author = class_author;
			}
		}
	}
